...
const Home: NextPage = () => {
  ...
  return (
    <>
      <div className="flex items-center flex-col flex-grow py-24">
        <h1 className="text-5xl font-semibold">SUS Blockchain</h1>
        <p className=" text-lg m-0">Uma nova forma de gerenciar a fila de transplante</p>
